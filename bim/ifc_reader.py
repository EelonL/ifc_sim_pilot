...
def read_ifc_elements(uploaded_file, max_objects: int | None = None) -> pd.DataFrame:
    ...
    try:
        ...
        # Uploaded IFC models can contain confidential project information.
        # IfcOpenShell parses the file synchronously, so the temporary copy is
        # no longer needed after open() returns (or fails).
